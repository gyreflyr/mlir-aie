...
// RUN: aiecc.py --xbridge --sysroot=%VITIS_SYSROOT% --aie-generate-xaiev2 %s -I%S/../../../../runtime_lib/ %S/../../../../runtime_lib/test_library.cpp %S/test.cpp -o test.elf
